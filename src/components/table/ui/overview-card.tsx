		...
		<div className='w-full h-[206px] p-6 bg-white rounded-lg shadow border border-gray-200 flex-col justify-start items-start gap-6 inline-flex'>
			...
			<div className='flex-col justify-start items-start gap-4 flex'>
				<div className='justify-start items-center gap-2 inline-flex'>
					<div className='w-[100px] h-2 p-0.5 bg-emerald-700 rounded' />
					<div className='w-40 h-2 p-0.5 bg-amber-500 rounded' />
					<div className='w-[130px] h-2 p-0.5 bg-red-700 rounded' />
				</div>
